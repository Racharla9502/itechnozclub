...
import 'organizing_projects_model.dart';
export 'organizing_projects_model.dart';

class OrganizingProjectsWidget extends StatefulWidget {
  const OrganizingProjectsWidget({
    super.key,
  ...
  @override
  _OrganizingProjectsWidgetState createState() =>
      _OrganizingProjectsWidgetState();
}

class _OrganizingProjectsWidgetState extends State<OrganizingProjectsWidget>
    with TickerProviderStateMixin {
  late OrganizingProjectsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganizingProjectsModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 1100.0,
                        decoration: const BoxDecoration(),
                        child: StreamBuilder<List<Projects05Record>>(
                          stream: queryProjects05Record(
                            queryBuilder: (projects05Record) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<Projects05Record> columnProjects05RecordList =
                                snapshot.data!;
                            ...
                            final columnProjects05Record =
                                columnProjects05RecordList.isNotEmpty
                                    ? columnProjects05RecordList.first
                                    : null;
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: Image.network(
                                                  columnProjects05Record.projectImage,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: false,
                                                tag: columnProjects05Record.projectImage,
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects05Record.image01,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects05Record.image01,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects05Record.image02,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects05Record.image02,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects05Record.image03,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects05Record.image03,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects05Record.image04,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects05Record.image04,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects05Record.projectReport);
                                              },
                                              text: 'Project report',
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects05Record.githubRepository);
                                              },
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects05Record.projectLink);
                                              },
                                              text: 'Project link',
                                              options: FFButtonOptions(
                                                height: 40.0,
