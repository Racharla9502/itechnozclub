...
import 'pr_projects_model.dart';
export 'pr_projects_model.dart';

class PrProjectsWidget extends StatefulWidget {
  const PrProjectsWidget({
    super.key,
  ...
  @override
  _PrProjectsWidgetState createState() => _PrProjectsWidgetState();
}

class _PrProjectsWidgetState extends State<PrProjectsWidget>
    with TickerProviderStateMixin {
  late PrProjectsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrProjectsModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 1100.0,
                        decoration: const BoxDecoration(),
                        child: StreamBuilder<List<Projects03Record>>(
                          stream: queryProjects03Record(
                            queryBuilder: (projects03Record) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<Projects03Record> columnProjects03RecordList =
                                snapshot.data!;
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: List.generate(
                                    columnProjects03RecordList.length,
                                    (columnIndex) {
                                  final columnProjects03Record =
                                      columnProjects03RecordList[columnIndex];
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      InkWell(
