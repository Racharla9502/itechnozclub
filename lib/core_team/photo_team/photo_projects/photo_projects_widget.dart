...
import 'photo_projects_model.dart';
export 'photo_projects_model.dart';

class PhotoProjectsWidget extends StatefulWidget {
  const PhotoProjectsWidget({
    super.key,
  ...
  @override
  _PhotoProjectsWidgetState createState() => _PhotoProjectsWidgetState();
}

class _PhotoProjectsWidgetState extends State<PhotoProjectsWidget>
    with TickerProviderStateMixin {
  late PhotoProjectsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhotoProjectsModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 1100.0,
                        decoration: const BoxDecoration(),
                        child: StreamBuilder<List<Projects04Record>>(
                          stream: queryProjects04Record(
                            queryBuilder: (projects04Record) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<Projects04Record> columnProjects04RecordList =
                                snapshot.data!;
                            ...
                            final columnProjects04Record =
                                columnProjects04RecordList.isNotEmpty
                                    ? columnProjects04RecordList.first
                                    : null;
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: Image.network(
                                                  columnProjects04Record.projectImage,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: false,
                                                tag: columnProjects04Record.projectImage,
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects04Record.image01,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects04Record.image01,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects04Record.image02,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects04Record.image02,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects04Record.image03,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects04Record.image03,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjects04Record.image04,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjects04Record.image04,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects04Record.projectReport);
                                              },
                                              text: 'Project report',
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects04Record.githubRepository);
                                              },
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjects04Record.projectLink);
                                              },
                                              text: 'Project link',
                                              options: FFButtonOptions(
                                                height: 40.0,
