...
import 'core_projects_model.dart';
export 'core_projects_model.dart';

class CoreProjectsWidget extends StatefulWidget {
  const CoreProjectsWidget({
    super.key,
  ...
  @override
  _CoreProjectsWidgetState createState() => _CoreProjectsWidgetState();
}

class _CoreProjectsWidgetState extends State<CoreProjectsWidget>
    with TickerProviderStateMixin {
  late CoreProjectsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoreProjectsModel());
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: Image.network(
                                                  columnProjectsRecord.projectImage,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: false,
                                                tag: columnProjectsRecord.projectImage,
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjectsRecord.image01,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjectsRecord.image01,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjectsRecord.image02,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjectsRecord.image02,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjectsRecord.image03,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjectsRecord.image03,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                              ...
                                              await Navigator.push(
                                                ...
                                                PageTransition(
                                                  ...
                                                  child:
                                                      FlutterFlowExpandedImageView(
                                                    image: Image.network(
                                                      columnProjectsRecord.image04,
                                                      fit: BoxFit.contain,
                                                    ),
                                                    allowRotation: false,
                                                    tag: columnProjectsRecord.image04,
                                                    useHeroAnimation: true,
                                                  ),
                                                ),
                                              );
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjectsRecord.projectReport);
                                              },
                                              text: 'Project report',
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjectsRecord.githubRepository);
                                              },
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                await launchURL(
                                                    columnProjectsRecord.projectLink);
                                              },
                                              text: 'Project link',
                                              options: FFButtonOptions(
                                                height: 40.0,
