...
import 'design_projects_model.dart';
export 'design_projects_model.dart';

class DesignProjectsWidget extends StatefulWidget {
  const DesignProjectsWidget({
    super.key,
    required this.designdocref,
  });

  final DocumentReference? designdocref;

  @override
  _DesignProjectsWidgetState createState() => _DesignProjectsWidgetState();
}

class _DesignProjectsWidgetState extends State<DesignProjectsWidget>
    with TickerProviderStateMixin {
  late DesignProjectsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesignProjectsModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 1100.0,
                        decoration: const BoxDecoration(),
                        child: StreamBuilder<List<Projects02Record>>(
                          stream: queryProjects02Record(
                            queryBuilder: (projects02Record) =>
                                projects02Record.where(
                              'ref',
                              isEqualTo: widget.designdocref,
                            ),
                          ),
                          builder: (context, snapshot) {
                            ...
                            List<Projects02Record> columnProjects02RecordList =
                                snapshot.data!;
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: List.generate(
                                    columnProjects02RecordList.length,
                                    (columnIndex) {
                                  final columnProjects02Record =
                                      columnProjects02RecordList[columnIndex];
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      InkWell(
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: Image.network(
                                                  columnProjects02Record
                                                      .projectImage,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: false,
                                                tag: columnProjects02Record
                                                    .projectImage,
