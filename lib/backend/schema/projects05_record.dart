...
class Projects05Record extends FirestoreRecord {
  Projects05Record._(
    super.reference,
    super.data,
  ) {
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('projects05')
          : FirebaseFirestore.instance.collectionGroup('projects05');

  static DocumentReference createDoc(DocumentReference parent) =>
      parent.collection('projects05').doc();

  static Stream<Projects05Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Projects05Record.fromSnapshot(s));

  static Future<Projects05Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Projects05Record.fromSnapshot(s));

  static Projects05Record fromSnapshot(DocumentSnapshot snapshot) =>
      Projects05Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Projects05Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Projects05Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Projects05Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Projects05Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createProjects05RecordData({
  String? projectName,
...
class Projects05RecordDocumentEquality implements Equality<Projects05Record> {
  const Projects05RecordDocumentEquality();

  @override
  bool equals(Projects05Record? e1, Projects05Record? e2) {
  ...
  @override
  int hash(Projects05Record? e) => const ListEquality().hash([
        e?.projectName,
        e?.updateDateAndTime,
        e?.projectImage,
        e?.projectLink,
  ...
  @override
  bool isValidKey(Object? o) => o is Projects05Record;
}
