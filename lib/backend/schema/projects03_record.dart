...
class Projects03Record extends FirestoreRecord {
  Projects03Record._(
    super.reference,
    super.data,
  ) {
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('projects03')
          : FirebaseFirestore.instance.collectionGroup('projects03');

  static DocumentReference createDoc(DocumentReference parent) =>
      parent.collection('projects03').doc();

  static Stream<Projects03Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Projects03Record.fromSnapshot(s));

  static Future<Projects03Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Projects03Record.fromSnapshot(s));

  static Projects03Record fromSnapshot(DocumentSnapshot snapshot) =>
      Projects03Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Projects03Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Projects03Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Projects03Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Projects03Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createProjects03RecordData({
  String? projectName,
...
class Projects03RecordDocumentEquality implements Equality<Projects03Record> {
  const Projects03RecordDocumentEquality();

  @override
  bool equals(Projects03Record? e1, Projects03Record? e2) {
  ...
  @override
  int hash(Projects03Record? e) => const ListEquality().hash([
        e?.projectName,
        e?.updateDateAndTime,
        e?.projectImage,
        e?.projectLink,
  ...
  @override
  bool isValidKey(Object? o) => o is Projects03Record;
}
