...
class Projects01Record extends FirestoreRecord {
  Projects01Record._(
    super.reference,
    super.data,
  ) {
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('projects01')
          : FirebaseFirestore.instance.collectionGroup('projects01');

  static DocumentReference createDoc(DocumentReference parent) =>
      parent.collection('projects01').doc();

  static Stream<Projects01Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Projects01Record.fromSnapshot(s));

  static Future<Projects01Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Projects01Record.fromSnapshot(s));

  static Projects01Record fromSnapshot(DocumentSnapshot snapshot) =>
      Projects01Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Projects01Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Projects01Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Projects01Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Projects01Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createProjects01RecordData({
  String? projectName,
...
class Projects01RecordDocumentEquality implements Equality<Projects01Record> {
  const Projects01RecordDocumentEquality();

  @override
  bool equals(Projects01Record? e1, Projects01Record? e2) {
  ...
  @override
  int hash(Projects01Record? e) => const ListEquality().hash([
        e?.projectName,
        e?.updateDateAndTime,
        e?.projectImage,
        e?.projectLink,
  ...
  @override
  bool isValidKey(Object? o) => o is Projects01Record;
}
