...
class Projects04Record extends FirestoreRecord {
  Projects04Record._(
    super.reference,
    super.data,
  ) {
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('projects04')
          : FirebaseFirestore.instance.collectionGroup('projects04');

  static DocumentReference createDoc(DocumentReference parent) =>
      parent.collection('projects04').doc();

  static Stream<Projects04Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Projects04Record.fromSnapshot(s));

  static Future<Projects04Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Projects04Record.fromSnapshot(s));

  static Projects04Record fromSnapshot(DocumentSnapshot snapshot) =>
      Projects04Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Projects04Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Projects04Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Projects04Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Projects04Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createProjects04RecordData({
  String? projectName,
...
class Projects04RecordDocumentEquality implements Equality<Projects04Record> {
  const Projects04RecordDocumentEquality();

  @override
  bool equals(Projects04Record? e1, Projects04Record? e2) {
  ...
  @override
  int hash(Projects04Record? e) => const ListEquality().hash([
        e?.projectName,
        e?.updateDateAndTime,
        e?.projectImage,
        e?.projectLink,
  ...
  @override
  bool isValidKey(Object? o) => o is Projects04Record;
}
