...
class CoreTeamRecord extends FirestoreRecord {
  ...
  // "listoskills" field.
  List<DocumentReference>? _listoskills;
  List<DocumentReference> get listoskills => _listoskills ?? const [];
  bool hasListoskills() => _listoskills != null;
  ...
  void _initializeFields() {
    ...
    _listoskills = getDataList(snapshotData['listoskills']);
...
class CoreTeamRecordDocumentEquality implements Equality<CoreTeamRecord> {
  ...
  bool equals(CoreTeamRecord? e1, CoreTeamRecord? e2) {
    ...
    return e1?.name == e2?.name &&
        ...
        listEquality.equals(e1?.listoskills, e2?.listoskills) &&
